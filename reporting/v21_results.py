...
def main():
    ...
    verification=load('results/v2.1/verification.json');assert verification['status']=='passed'
    tr=load('results/v2.1/inat/training.json');osr=load('results/v2.1/inat/open_set.json');mon=load('results/v2.1/inat/monitoring.json');lock=load('data/v2.1/manifests/lock.json')
    figdir=ROOT/'results/v2.1/figures';figdir.mkdir(parents=True,exist_ok=True)
    ...
    write_json(ROOT/'results/v2.1/summary.json',summary)
