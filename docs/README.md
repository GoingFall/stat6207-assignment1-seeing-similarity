...
- `report/`: generated report text and report-revision records. The rendered PDF remains at the project root and in `site/report.pdf`.
...
Historical documents remain inside `backup/` and are not active project documentation.
